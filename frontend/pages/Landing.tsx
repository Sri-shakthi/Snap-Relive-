    ...
    <Layout showHeader={false}>
      <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
        ...
        >
          ...
          <p className="text-stone-500 text-lg italic">{APP_TAGLINE}</p>
        </motion.div>
        ...
        <div className="space-y-5 w-full px-4">
          <div className="space-y-2">
            ...
            <p className="text-stone-500 leading-relaxed">
              This page is only a fallback. Open the guest or photographer link shared by the organizer to see your matches on the website and receive selected photos from SnapShots on WhatsApp.
            </p>
          </div>
